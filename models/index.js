...
const Departement = require("./departement")(sequelize);
const Galery = require("./galery")(sequelize);
...
User.hasMany(Departement, { foreignKey: "userId" });
Departement.belongsTo(User, { foreignKey: "userId" });
